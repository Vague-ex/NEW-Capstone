# Generated migration for new EmploymentProfile, WorkAddress, CompetencyProfile models
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tracer', '0005_verificationdecision'),
    ...
    operations = [
            ...
            fields=[
                ...
                ('first_job_source', models.CharField(
                    ...
                    choices=[
                        ...
                        ('online_portal', 'Online Job Portal'),
                        ('career_fair', 'CHMSU Career Fair'),
                        ('walk_in', 'Company Walk-in/Direct Hire'),
                        ('social_media', 'Social Media'),
                        ('entrepreneurship', 'Started own business/Freelance'),
                        ('other', 'Other')
                    ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['alumni', '-updated_at'], name='tracer_empl_alumni_updated_idx'),
        ),
        migrations.AddIndex(
            model_name='employmentprofile',
            index=models.Index(fields=['employment_status'], name='tracer_empl_status_idx'),
        ),
        migrations.AddIndex(
            model_name='workaddress',
            index=models.Index(fields=['alumni', '-is_current'], name='tracer_work_alumni_current_idx'),
        ),
        migrations.AddIndex(
            model_name='workaddress',
            index=models.Index(fields=['region'], name='tracer_work_region_idx'),
        ),
    ]
