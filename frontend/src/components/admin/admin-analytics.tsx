...
export function AdminAnalytics() {
  ...
  return (
    <PortalLayout
      ...
      pageSubtitle="Model-driven employment predictions"
    >
      <div className="space-y-6">
        {/* Cohort selector + loading/error */}
          ...
          {[
            {
              ...
              trend: overall
                ? `Actual: ${pct(overall.actual_employment_rate)}`
                : '',
              up: true,
            },
            {
              ...
              sub: overall
                ? `Actual: ${overall.actual_mean_time_to_hire_months.toFixed(1)}mo`
                : '',
              icon: Clock,
              bg: 'bg-blue-50',
              color: 'text-blue-600',
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div
                  className={`flex size-10 items-center justify-center rounded-xl ${k.bg}`}
                >
